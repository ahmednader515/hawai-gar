...
// Each card has its own image; on hover that card’s image is shown full-width as the background.
const SOLUTIONS = [
  {
    id: "shipping",
    title: "حلول الشحن",
    titleEn: "Shipping Solutions",
    icon: (
    ...
    image: "/land-shipping-1.png",
  },
  {
    id: "inland",
    title: "النقل البري والخدمات اللوجستية",
    titleEn: "Inland Transportation & Logistics",
    icon: (
      <svg className="w-full h-full" viewBox="0 0 64 64" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
    ...
    image: "/land-shipping-2.png",
  },
  {
    id: "digital",
    title: "حلول الأعمال الرقمية",
    titleEn: "Digital Business Solutions",
    icon: (
      <svg className="w-full h-full" viewBox="0 0 64 64" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
    ...
    image: "/land-shipping-3.png",
  },
  {
    id: "cargo",
    title: "حلول تغطية الشحن",
    titleEn: "Cargo Cover Solutions",
    icon: (
      <svg className="w-full h-full" viewBox="0 0 64 64" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
...
export function SolutionsSection() {
  ...
  return (
    <section id="solutions" className="relative">
      ...
      {/* Full-width image area: one shared bg, hover layers full width */}
      <div className="relative min-h-[380px] sm:min-h-[420px] md:min-h-[500px]">
        {/* Default: first card’s image; once a card is hovered, that card’s layer stays visible (see hover layers below) */}
        ...
        {/* When a card is hovered: that card’s image becomes the background and stays until another card is hovered */}
        ...
        {/* 4 cards: content only, semi-transparent overlay; no per-card background */}
        <div className="relative z-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 h-full min-h-[380px] sm:min-h-[420px] md:min-h-[500px]">
          {SOLUTIONS.map((solution, index) => (
            ...
            >
              {/* Card overlay: desktop = vertical borders between columns; mobile = horizontal borders between rows (same line style, no shadow). */}
              <div
              ...
              <div className="relative z-10 flex flex-col items-center justify-center w-full h-full">
                ...
                <h3 className="text-center font-semibold text-lg md:text-xl leading-tight">
                  {solution.title}
                </h3>
                <p className="text-white/80 text-sm mt-1 hidden sm:block text-center">
                  {solution.titleEn}
                </p>
              </div>
            </div>
